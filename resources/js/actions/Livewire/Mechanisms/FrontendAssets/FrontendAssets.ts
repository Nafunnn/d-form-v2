...
* @route '/livewire-4aacd38c/livewire.js'
*/
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-4aacd38c/livewire.js',
...
* @route '/livewire-4aacd38c/livewire.min.js.map'
*/
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-4aacd38c/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/livewire-4aacd38c/livewire.csp.min.js.map'
*/
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-4aacd38c/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
